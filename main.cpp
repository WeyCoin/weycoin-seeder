...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Weycoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.weycoinproject.org", ""};
static const string testnet_seeds[] = {"testnet-dnsseed.weycoinproject.org", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("ri7rzlmdaf4eqbza.onion", 11526), true);
  }
  do {
